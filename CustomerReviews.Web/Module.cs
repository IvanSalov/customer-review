...
namespace CustomerReviews.Web
{
    public class Module : ModuleBase
    {
        ...
        public override void Initialize()
        {
            ...
            _container.RegisterType<IProductRatingRepository>(new InjectionFactory(c => new ProductRatingRepository(_connectionString, new EntityPrimaryKeyGeneratorInterceptor(), _container.Resolve<AuditableInterceptor>())));
